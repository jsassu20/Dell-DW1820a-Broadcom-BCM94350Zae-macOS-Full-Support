...
{
                                                                     // *** SECTION 1 *** \\
    External (_SB_.PCI0.<YOUR LAPTOP'S NGFF IOREG NAME>, UnknownObj)
    //                  -------------------------------
                                                                     // Replace "<NGFF PORT'S IOREG NAME>" with the name of the NGFF port that your WiFi/USB card has been installed in (Like RP0x or EXPx with x being a number 1-9)
                                                      ...
                                                      // *** SECTION 2 *** \\                                                        
    Device (_SB.PCI0.<YOUR LAPTOP'S NGFF IOREG NAME>)
    {//              ------------------------------- 
                                                      // Replace "<NGFF PORT'S IOREG NAME>" here with the same name you replaced in the above line for External (_SB_.PCI0.<YOUR LAPTOP'S NGFF IOREG NAME> 
